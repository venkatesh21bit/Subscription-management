"""
Base Django settings for Vendor ERP Backend.
...
INSTALLED_APPS = [
    ...
    'apps.pricing',
    'apps.workflow',
    'apps.subscriptions',  # NEW: Subscription Management System
    'integrations.gst',
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'core.utils.exceptions.unified_exception_handler',
}
